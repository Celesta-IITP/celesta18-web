			...
			<div class="bs-docs-example">
				...
				<table class="table table-striped col-md-8">
					...
					<?php
						...
						include 'apiLe/render/log.php';
						include 'apiLe/render/checkAccess.php';
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-4 w3ls_footer_grid_left">
						...
						<p>
							<span><a href="mailto:rishabh.ee16@iitp.ac.in">rishabh.ee16@iitp.ac.in</a></span>
							<span><a href="mailto:ilagaraju.ch17@iitp.ac.in">ilagaraju.ch17@iitp.ac.in</a></span>
						</p>
					</div>
				</div>
