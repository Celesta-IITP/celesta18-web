		...
		function member_row(data, i, even){
			...
			span_1.setAttribute("style", "color: black; padding-left: 5px;");
     		...
     		if(even==1){
				...
				img1.setAttribute("style", "border-radius:50%;width:7em;height:7em;");
				img1.setAttribute("src", "images/team/"+image);
				...
				h2_1.setAttribute("style", "text-decoration:none");
				h2_1.innerHTML = name;
				div4.appendChild(h2_1);
			
				var h4_1 = document.createElement("h4");
				h4_1.setAttribute("style", "color: red;");
				h4_1.innerHTML = "Contact: ";
				div4.appendChild(h4_1);

				var span1 = document.createElement("span");
				span1.setAttribute("style", "color: black; padding-left: 5px;");
     			span1.innerHTML = mobile;
     			h4_1.appendChild(span1);

     			var h4_12 = document.createElement("h4");
				h4_12.setAttribute("style", "color: red;");
     			h4_12.innerHTML = "Email: ";
				div4.appendChild(h4_12);

				var span12 = document.createElement("span");
				span12.setAttribute("style", "color: black; padding-left: 5px;");
     			span12.innerHTML = email;
     			h4_12.appendChild(span12);
   			}  
		}		
