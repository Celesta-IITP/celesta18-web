			...
			$(document).ready(function() {
				...
				$(".text1_li1").hover(function() {
						...
						$("#Robotics1, #Robotics2, #Robotics3").html("Default Text for Robotics");
				});
				...
				$(".text2_li1").hover(function() {
						...
						$("#Build-It1,#Build-It2,#Build-It3").html("Default Text for Build-It");
				});
				...
				$(".text3_li1").hover(function() {
						...
						$("#Coding1,#Coding2,#Coding3").html("Default Text for Let's Code");
				});
				...
				$(".text4_li1").hover(function() {
						...
						$("#Management1,#Management2,#Management3").html("Default Text for Management");
				});
				...
				$(".text5_li1").hover(function() {
						...
						$("#Treasure-Hunt1,#Treasure-Hunt2,#Treasure-Hunt3").html("Default Text for Treasure-Hunt");
				});
				...
				$(".text6_li1").hover(function() {
						...
						$("#Debate1,#Debate2,#Debate3").html("Default Text for Debate");
				});
				...
				$(".text7_li1").hover(function() {
						...
						$("#Expo1,#Expo2,#Expo3").html("Default Text for Expo");
				});
				...
				$(".text8_li1").hover(function() {
						...
						$("#Quiz-Wiz1,#Quiz-Wiz2,#Quiz-Wiz3").html("Default Text for Quiz-Wiz");
				});
				...
				$(".text9_li1").hover(function() {
						...
						$("#Social1,#Social2,#Social3").html("Default Text for Social");
				});
