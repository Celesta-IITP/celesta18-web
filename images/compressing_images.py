...
def compressMe(file, verbose=False):
	...
	picture.save("./comp/"+"Compressed_"+file,"JPEG",optimize=True,quality=60) 
	
	newsize = os.stat(os.path.join(os.getcwd(),"comp","Compressed_"+file)).st_size
